...
def parse_args():
    ...
    parser.add_argument('--save-dir', default='/scratch/mariamma/pascal_voc/models/minmax',
...
class Trainer(object):
    ...
    #     self.optimizer, patience=4, verbose=True, factor=0.1
    # )
    ...
    def train(self):
        ...
        for iteration, (images, targets, _) in enumerate(self.train_loader):
            ...
            losses = loss_dict.max() #sum(loss for loss in loss_dict)/len(loss_dict)
    ...
    def validation(self):
        ...
        # self.scheduler.step(np.mean(eval_loss))
...
def save_checkpoint(model, args, is_best=False):
    ...
    filename = '{}_{}_{}_max.pth'.format(args.model, args.backbone, args.dataset)
    ...
    if is_best:
        best_filename = '{}_{}_{}_best_model_max.pth'.format(args.model, args.backbone, args.dataset)
